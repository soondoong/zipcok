...
public class AjaxPagingModuleSY {

	
	public static String makePage(int totalcount,int cp, int listSize,int pageSize,String jsname) {
	...
	/*제이슨 표기법 유의*/
		  ...
		  * */
		 		if(userGroup!=0){          
		 			...
		 			sb.append("<a  href='javascript:"+jsname+"("+temp+")");		 				
		 			...
		 			for(int i=(userGroup*pageSize)+1;i<=(userGroup*pageSize)+pageSize;i++){
		 					...
		 					sb.append("<a href='javascript:"+jsname+"("+i+")");				 		
		 					sb.append("'>");
		 					sb.append(i);
		 					sb.append("</a>");

...
public interface AdminCommDAO {
	...
	public int allCommCount();//모든 커뮤니티 갯수 구하기
	public int searchCommCount(String com_name);//검색 커뮤니티 갯수 구하기
	...
	public String getStartDate(int ex_comm_idx,String ex_id);//최근 활동 날짜 구하기
	public List<String> getCommList(String uc_mem_id);//소속 커뮤니티 목록 구하기
	public double getBbsAvgCount(int ex_comm_idx);//일일 평균 게시물 갯수 구하기
}

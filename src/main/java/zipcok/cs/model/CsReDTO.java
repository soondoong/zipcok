...
public class CsReDTO {
	...
	public CsReDTO(int re_idx, int re_bbs, int re_comm_idx, String re_id, String re_content, Date re_writedate,
			int re_group, int re_lev, int re_sunbun, int re_bbs_idx) {
		super();
		this.re_idx = re_idx;
		this.re_bbs = re_bbs;

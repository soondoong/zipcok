...
<c:set var="profile" value='${sessionScope.login }' />
	...
	<div class="col-12" style="margin-top: 20px; margin-bottom: 15px;">
		<div class="col-12" style="float: left">
			...
			<span
				style="float: right; width: 30%; height: 65px; text-align: center; background-color: #01D1FE; border-radius: 5px;">
				<button
				style="margin-top: 30px; text-align: center; color: white; font-weight: bold; " id = "sendBtn"><br>전송</button>
			</span>
		</div>
 ...
 function send() {
  ...
  if(msg != ""){
	  ...
	  message.Msg_content = $("#message").val()
  	  message.Msg_coachid = '김코치'
  	  message.Msg_userid= '수연고객'
  	  message.Msg_req_idx = '1'
  	  message.Msg_sender = '새션아이디'
  }

					...
					<div class="hgDIV">
						...
						<div class = "hgRightDIV">
							...
							<div class = "paymentArea infoDIV">
								...
								<c:if test = "${!empty paymentContent }">
									<span class = "labelName">은행명</span><input type = "button" value = "수정" class = "rebtn" onclick = "javascript:mypageHomeGymPaymentUpdatePopup();"><br>
									<span id = "banknameSpan" class = "dateName">${paymentContent.pa_bankname }</span><br>
									<span class = "labelName">예금주</span><br>
									<span id = "usernameSpan" class = "dateName">${paymentContent.pa_username }</span><br>
									<span class = "labelName">계좌 번호</span><br>
									<span id = "noSpan"class = "dateName">${paymentContent.pa_no }</span>
								</c:if>
								</div>
						</div>
					</div>

...
<li class="sidemenuli"><a href="mypagePayList.do?mem_id=${sessionScope.sid}">결제내역</a></li>
<li class="sidemenuli"><a href="#">내 홈짐보기</a></li>
<li class="sidemenuli"><a href="#">채팅방</a></li>
<li class="sidemenuli"><a href="mypageWriteList.do?mem_id=${sessionScope.sid}">작성글관리</a></li>
</ul>
</div>
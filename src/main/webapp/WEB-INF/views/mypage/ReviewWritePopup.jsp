...
.ReviewWrap{width:524px; padding:40px 30px 30px 30px;}
...
<div class="ReviewWrap">
	...
	<hr>
	<div class="starDiv">
	<input type="radio" name="starnum" value="1"><img src="img/coach/star/star1.jpg" class="starimg">
		<input type="radio" name="starnum" value="2"><img src="img/coach/star/star2.jpg" class="starimg">
			<input type="radio" name="starnum" value="3"><img src="img/coach/star/star3.jpg" class="starimg"> 
				<input type="radio" name="starnum" value="4"><img src="img/coach/star/star4.jpg" class="starimg">
					<input type="radio" name="starnum" value="5" checked><img src="img/coach/star/star5.jpg" class="starimg">
	</div>	
